...
class AutoKick(Base):
    ...
    owner: Mapped["Member"] = relationship("Member", foreign_keys=[owner_id], backref="owned_autokicks")
    target: Mapped["Member"] = relationship("Member", foreign_keys=[target_id], backref="autokicks_targeting")
...
class ModerationLog(Base):
    ...
    moderator: Mapped["Member"] = relationship("Member", foreign_keys=[moderator_id], backref="moderation_logs_given")
