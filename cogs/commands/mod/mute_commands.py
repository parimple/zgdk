...
class MuteCommands(ServiceCog):
    ...
    @is_mod_or_admin()
    @discord.app_commands.describe(user="Użytkownik, któremu chcesz zablokować możliwość streamowania")
    ...
    @is_mod_or_admin()
    @discord.app_commands.describe(user="Użytkownik, któremu chcesz zablokować możliwość zdobywania punktów")
    ...
    @commands.hybrid_group(name="unmute", description="Komendy związane z odwyciszaniem użytkowników.")
    @is_mod_or_admin()
    @discord.app_commands.describe(user="Użytkownik do odwyciszenia (opcjonalnie, działa jak unmute txt)")
    ...
    @unmute.command(name="txt", description="Przywraca możliwość wysyłania wiadomości użytkownikowi.")
    @is_mod_or_admin()
    ...
    @unmute.command(name="live", description="Przywraca możliwość streamowania użytkownikowi.")
    @is_mod_or_admin()
