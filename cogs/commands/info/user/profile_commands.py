...
from .profile_helpers import get_active_mutes, get_profile_data
from .views import BuyRoleButton, ProfileView, SellRoleButton
        ...
        async with self.bot.get_db() as session:
            try:
                ...
                try:
                    ...
                    logger.info(
                        f"Profile embed sent successfully for {member}. Message ID: {message.id if message else 'None'}"
                    )
