...
class EnhancedModerationCommands(commands.Cog):
    ...
    async def timeout_ai(
        ...
        duration: str,
        *,
        reason: str = "Brak podanego powodu"
    ):
        """
        ...
        try:
            ...
            embed = discord.Embed(
                title="⏰ Potwierdzenie Wyciszenia",
    ...
    async def analyze_message(
        ...
        try:
            ...
            user_context = UserContext(
                ...
                is_new_user=(message.author.joined_at and 
                           (discord.utils.utcnow() - message.author.joined_at).days < 7),
            ...
            # Analyze with AI
            analysis = await self.mod_assistant.analyze_message(
                message.content,
                user_context
            )
            ...
            if analysis.violations:
                embed.add_field(
                    ...
                    value=", ".join(v.value for v in analysis.violations),
                    inline=False
                )
            ...
            if analysis.evidence:
                embed.add_field(
                    name="Dowody",
                    value="\n".join(f"• {e}" for e in analysis.evidence[:3]),
                    inline=False
                )
    ...
    @commands.hybrid_command(
        name="parsuj_czas",
        description="Testuj parsowanie czasu AI"
    )
    async def parse_duration_test(self, ctx: commands.Context, *, duration: str):
        ...
        try:
            ...
            embed = discord.Embed(
                title="⏱️ Wynik Parsowania Czasu",
