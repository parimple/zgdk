...
class RoleValidation:
    ...
    def is_role_upgrade(current_role: str, new_role: str, premium_roles: List[Dict]) -> bool:
        ...
        current_index = next((i for i, r in enumerate(premium_roles) if r["name"] == current_role), -1)
        new_index = next((i for i, r in enumerate(premium_roles) if r["name"] == new_role), -1)
