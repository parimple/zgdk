...
def create_upgrade_embed(current_role: str, new_role: str, price: int, refund: int, member_color: discord.Color = None) -> discord.Embed:
...
def create_downgrade_embed(current_role: str, new_role: str, price: int, days: int = 30, member_color: discord.Color = None) -> discord.Embed:
...
def create_error_embed(message: str, member_color: discord.Color = None) -> discord.Embed:
    ...
    embed = discord.Embed(
        ...
        color=member_color if member_color else ShopEmbedColors.ERROR
    )
    return embed
...
def create_cancel_embed(member_color: discord.Color = None) -> discord.Embed:
    ...
    embed = discord.Embed(
        description="❌ Transakcja została anulowana",
        color=member_color if member_color else ShopEmbedColors.ERROR
    )
    return embed
