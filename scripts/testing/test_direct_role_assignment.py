...
async def test_direct_role_assignment():
    ...
    premium_roles = {"zG100": "1027629813788106814", "zG500": "1027629916951326761", "zG1000": "1027630008227659826"}
    ...
    async with aiohttp.ClientSession() as session:
        ...
        team_names = ["TestTeam", "My Awesome Team", "Squad 500"]
        ...
        try:
            command_data = {"command": "color", "channel_id": channel_id, "author_id": test_user_id}
