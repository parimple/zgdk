        ...
        async def on_ready():
            ...
            if self.shop_message and hasattr(self.shop_message, 'components'):
                ...
                try:
                    ...
                    if (self.shop_message.components and 
                        len(self.shop_message.components) > 0 and
                        hasattr(self.shop_message.components[0], 'children') and
                        len(self.shop_message.components[0].children) > 0):
            ...
            try:
                ...
                with open(filename, 'w') as f:
                    json.dump({
                        ...
                        "buttons_detected": bool(self.shop_message and hasattr(self.shop_message, 'components') and self.shop_message.components),
