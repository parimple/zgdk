...
async def test_complete_premium_cycle():
    ...
    msg_deletion_confirm = "User needs to confirm with reaction"
    msg_color_removed = "Color removed"
    ...
    async with aiohttp.ClientSession() as session:
        ...
        print(f"Test will create and clean up all test data\n")
