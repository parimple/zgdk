...
class CacheManager:
    ...
    def cache(self, namespace: str = "default", ttl: Optional[int] = None, key_func: Optional[Callable] = None):
        """
    ...
    async def _invalidate_cached(self, func: Callable, namespace: str, key_func: Optional[Callable], *args, **kwargs):
