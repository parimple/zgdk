...
class IntelligentErrorHandler:
    ...
    async def handle_error(
        self, error: Exception, command: Optional[str] = None, context: Optional[Dict[str, Any]] = None
    ) -> ErrorResponse:
        ...
        if self.use_ai:
            return await self._generate_ai_response(error, command, context, category)
    ...
    async def _generate_ai_response(
        self, error: Exception, command: Optional[str], context: Optional[Dict[str, Any]], category: ErrorCategory
    ) -> ErrorResponse:
    ...
    def _generate_fallback_response(
        self, error: Exception, command: Optional[str], category: ErrorCategory
    ) -> ErrorResponse:
        ...
        category_messages = {
            ...
            ErrorCategory.VALIDATION: ("Invalid input provided.", "Check the command format and try again."),
            ErrorCategory.NOT_FOUND: (
            ...
            ErrorCategory.DATABASE: ("Database error occurred.", "This is temporary - please try again later."),
            ErrorCategory.NETWORK: ("Network connection issue.", "Check your connection and try again."),
            ErrorCategory.UNKNOWN: ("An unexpected error occurred.", "Try again or contact support if it persists."),
        }

        message, suggestion = category_messages.get(category, ("An error occurred.", "Please try again."))
    ...
    async def generate_command_help(self, command: str, error: Optional[Exception] = None) -> str:
...
async def handle_command_error(
    error: Exception, command: Optional[str] = None, context: Optional[Dict] = None, use_ai: bool = True
) -> ErrorResponse:
