...
class EnhancedColorInput(BaseModel):
    ...
    @classmethod
    def from_color_input(cls, color: ColorInput, interpretation: str = "", confidence: float = 1.0, closest_named: Optional[str] = None) -> 'EnhancedColorInput':
    ...
    async def _parse_with_ai(self, color_str: str) -> EnhancedColorInput:
        ...
        try:
            ...
            result = await self.agent.run(
                f"Konwertuj ten opis koloru na hex: '{color_str}'"
            )
