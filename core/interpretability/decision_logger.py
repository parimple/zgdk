...
class DecisionLogger:
    ...
    def log_permission_check(
        ...
        **kwargs,
        ...
        decision = Decision(
            ...
            checked_conditions=[{"permission": perm, "has": perm in user_permissions} for perm in required_permissions],
            context={"required_permissions": required_permissions, "user_permissions": user_permissions, **kwargs},
        )
    ...
    def log_moderation_action(
        self, moderator_id: str, target_id: str, action: str, reason: str, duration: Optional[int] = None, **kwargs
    ) -> Decision:
    ...
    def log_purchase_validation(
        ...
        **kwargs,
        ...
        decision = Decision(
            ...
            context={"item": item, "price": price, "user_balance": user_balance, **kwargs},
    ...
    def log_ai_decision(
        self, user_id: str, ai_model: str, input_text: str, output: Any, confidence: float, reasoning: str, **kwargs
    ) -> Decision:
        ...
        decision = Decision(
            ...
            context={"model": ai_model, "input": input_text, "output": output, **kwargs},
        )
