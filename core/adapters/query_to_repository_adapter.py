...
class AutoKickQueriesAdapter:
    ...
    @staticmethod
    async def get_owner_autokicks(session: AsyncSession, owner_id: int):
    ...
    @staticmethod
    async def get_target_autokicks(session: AsyncSession, target_id: int):
...
class ChannelPermissionQueriesAdapter:
    ...
    async def add_or_update_permission(
        ...
        return await repo.add_or_update_permission(
            member_id, target_id, allow_permissions_value, deny_permissions_value, guild_id
        )
    ...
    @staticmethod
    async def get_permission(session: AsyncSession, member_id: int, target_id: int):
    ...
    @staticmethod
    async def get_permissions_for_target(session: AsyncSession, target_id: int):
    ...
    @staticmethod
    async def get_permissions_for_member(session: AsyncSession, member_id: int, limit: int = 95):
...
class InviteQueriesAdapter:
    ...
    async def add_or_update_invite(
        ...
        return await repo.add_or_update_invite(invite_id, creator_id, uses, created_at, last_used_at)
    ...
    @staticmethod
    async def get_sorted_invites(session: AsyncSession, sort_by: str = "uses", order: str = "desc"):
    ...
    @staticmethod
    async def get_member_valid_invite_count(session: AsyncSession, member_id: int, guild, min_days: int = 7):
...
class RoleQueriesAdapter:
    ...
    @staticmethod
    async def delete_member_role(session: AsyncSession, member_id: int, role_id: int) -> bool:
...
class HandledPaymentQueriesAdapter:
    ...
    @staticmethod
    async def get_payment_by_id(session: AsyncSession, payment_id: int) -> Optional[object]:
    ...
    @staticmethod
    async def get_payment_by_name_and_amount(session: AsyncSession, name: str, amount: int) -> Optional[object]:
...
class ModerationLogQueriesAdapter:
    ...
    @staticmethod
    async def get_user_mute_history(session: AsyncSession, user_id: int, limit: int = 50) -> list:
    ...
    async def get_moderator_actions(
        ...
        repo = ModerationRepository(session)
        return await repo.get_moderator_actions(moderator_id, action_type, days_back, limit)

    @staticmethod
    async def get_mute_statistics(session: AsyncSession, days_back: int = 30) -> dict:
    ...
    @staticmethod
    async def get_recent_actions(session: AsyncSession, limit: int = 20) -> list:
