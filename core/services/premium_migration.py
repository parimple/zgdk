    ...
    async def get_service(self):
        ...
        if not self._service:
            ...
            self._service = ConsolidatedPremiumService(
                premium_repository=premium_repo, payment_repository=payment_repo, bot=self.bot
            )
...
class PremiumRoleManagerAdapter:
    ...
    async def assign_or_extend_premium_role(self, session, member, role_name, amount, duration_days=30, source="shop"):
