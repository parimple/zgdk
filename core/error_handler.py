...
from typing import Callable, TypeVar, Optional, Any, Dict, Union
import discord
        ...
        async def wrapper(*args, **kwargs) -> T:
            try:
                ...
                raise BotError(
                    ...
                    error_code=ErrorCodes.INTERNAL
                ) from e
    ...
    async def on_command_error(self, ctx: commands.Context, error: Exception):
        ...
        if isinstance(error, commands.MissingPermissions):
            perm_error = PermissionError(
                action="command",
                user_message="Brak uprawnień do wykonania tej komendy."
            )
